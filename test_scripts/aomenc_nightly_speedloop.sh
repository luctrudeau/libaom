...
s_log_file=av1_s0_$date_str.txt
...
#speed=0
bd=8
$script_path/aom_nightly_speedloop.sh $av1_code $pdfps $petime $speed $bd $html_log_file >> $log_path/av1_s$speed_$date_str.txt 2>&1
done
