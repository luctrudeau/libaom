...
echo "    <th colspan=\"9\">AV1 Speed Weekly: crowd_run_1080p_10.y4m bitrate=$bitrate profile=$profile frames=$frames </th>" >> $log_path/$html_log_file
echo " </tr>" >> $log_path/$html_log_file
echo "  <tr>" >> $log_path/$html_log_file
...
echo " </tr>" >> $log_path/$html_log_file
echo "  <tr>" >> $log_path/$html_log_file
echo "    <td colspan=\"9\">Note: VP9_enc_time=2431758, VP9_dec_time=2747652 $psnr" >> $log_path/$html_log_file
echo " </tr>" >> $log_path/$html_log_file
